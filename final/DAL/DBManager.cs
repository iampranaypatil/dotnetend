...
namespace DAL;
    ...
    public static string conString = @"server=127.0.0.1;uid=root;pwd=root123;database=dotnet";
    ...
    {  
        ...
        string query = $"insert into employees values(" +
            $"{emp.EmpId},'{emp.Name}','{emp.Email}','{emp.Password}','{emp.Location}','{emp.JoinDate:yyyy-MM-dd}',{emp.Salary})";
        MySqlConnection con = new MySqlConnection(conString);
        try
        {
            con.Open();
